...
class Page0:
    ...
    def __init__(self, master=None):
        ...
        f1 = tkfont.Font(size=45, family="GenSenRounded TW B")
        f2 = tkfont.Font(size=20, family="GenSenRounded TW M")
        ...
        self.btnStart = Button(self.page0, text='開始使用', bg=self._from_rgb((255, 217, 102)), font=f2, width=100,
                                  height=30, command=self.click_btnStart)
...
class Page1:
    ...
    def __init__(self, master=None):
        ...
        f1 = tkfont.Font(size=30, family="GenSenRounded TW B")
        f2 = tkfont.Font(size=20, family="GenSenRounded TW M")
        ...
        self.btnCreate_New = Button(self.frame_context1, text="創建新會議", height=30, width=125, font=f2,
        ...
        for i in range(len(meeting_names)):
            self.btn_names = Button(self.frame_context1, text=meeting_names[i], height=60, width=150, relief='solid', font=f1,
    ...
    def create_window(self):
        ...
        f1 = tkfont.Font(size=20, family="GenSenRounded TW B")
        f2 = tkfont.Font(size=15, family="GenSenRounded TW M")
        f3 = tkfont.Font(size=10, family="GenSenRounded TW M")
        ...
        self.btnYes = Button(self.window, text="確認", height=25, width=55, bg=self._from_rgb((255, 217, 102)), font=f2,
                                command=self.click_btnYes)
        self.btn_delete = Button(self.window, text="刪除日期", height=25, width=50, font=f3, command=self.click_btn_delete)
...
class Page3:
    ...
    def __init__(self, master=None):
        ...
        f1 = tkfont.Font(size=30, family="GenSenRounded TWGenSenRounded TW B")
        f2 = tkfont.Font(size=20, family="GenSenRounded TWGenSenRounded TW M")
        f3 = tkfont.Font(size=15, family="GenSenRounded TWGenSenRounded TW M")

        self.lab_title_3 = tk.Label(self.page3, text=' ' + name, height=1, width=15, font=f1, bg=color_1, fg='white',
                                    anchor='w')
        self.btn_createtime = Button(self.page3, text="新增你的時間", height=35, width=230, font=f2, fg=color_1,
                                        relief='solid', command=self.click_btn_createtime)
        self.btn_times = Button(self.page3, text="查看所有人的時間", height=35, width=230, font=f2, fg=color_1,
                                   relief='solid', command=self.click_btn_times)
        self.btn_meetingrecord = Button(self.page3, text="紀錄會議", height=35, width=230, font=f2, fg=color_1,
                                           relief='solid', command=self.click_btn_meetingrecord)
        self.btn_back = Button(self.page3, text="返回", height=25, width=40, font=f3, command=self.click_btn_back, bg=color_3)
...
class Page4:
    ...
    def __init__(self, master=None):
        ...
        f1 = tkfont.Font(size=30, family="GenSenRounded TW B")
        f2 = tkfont.Font(size=20, family="GenSenRounded TW M")
        f3 = tkfont.Font(size=15, family="GenSenRounded TW M")
...
class Page5:
    ...
    def __init__(self, master=None):
        ...
        f1 = tkfont.Font(size=30, family="GenSenRounded TW B")
        f2 = tkfont.Font(size=12, family="GenSenRounded TW M")
        f3 = tkfont.Font(size=15, family="GenSenRounded TW M")
        f4 = tkfont.Font(size=10, family="GenSenRounded TW M")
...
class Page6:
    ...
    def __init__(self, master=None):
        ...
        self.lblTitle_6 = tk.Label(self.page6, text=' ' + name + '-紀錄', height=1, width=15, font=f1, bg=color_1,
                                   fg='white', anchor='w').place(x=0, y=50)
        self.btn6_1 = Button(self.page6, text="出缺勤", height=35, width=230, font=f2, relief='solid', fg=color_1,
                                command=self.click_btn6_1)
        self.btn6_2 = Button(self.page6, text="會議記錄", height=35, width=230, font=f2, relief='solid', fg=color_1,
                                command=self.click_btn6_2)
        self.btn6_3 = Button(self.page6, text="結束會議", height=35, width=230, font=f2, relief='solid', fg=color_1,
                                command=self.click_btn6_3)
        self.btn6_4 = Button(self.page6, text="返回", height=25, width=40, font=f3, bg=color_3, command=self.click_btn6_4)
...
class Page7:
    ...
    def __init__(self, master=None):
        ...
        self.btn7_1 = Button(self.frame_context, text="確定", height=25, width=40, font=f3, bg=color_3, command=self.click_btn7_1)
...
class Page8:
    ...
    def __init__(self, master=None):
        ...
        self.btn8 = Button(self.page8, text='確認', height=25, width=40, font=f2, bg=color_3, command=self.click_btn8)
        ...
        if str(meeting_record.cell(row=1, column=2).value) != 'None':
            var_times.set(meeting_record.cell(row=1, column=2).value)
...
class Page9:
    ...
    def __init__(self, master=None):
        ...
        self.btn9 = Button(self.frame_context9, text="確定", height=25, width=40, font=f3, bg=color_3, command=self.click_btn9_1)
