...
class Page4:
    def __init__(self, master=None):
        ...
        self.lab_title = tk.Label(self.page4, relief='solid', width=15, height=1, text='新增你的時間', font=f3, anchor='nw').place(x=0, y=100)
        ...
        self.lab_name.place(x=100, y=220)
        self.int_name.place(x=100, y=260, height=30)
...
class Page5:
    def __init__(self, master=None):
        ...
        self.lab_title = tk.Label(self.page5, relief='solid', width=15, height=1, text='查看所有人的時間', font=f3, anchor='nw').place(x=0, y=100)
        ...
        self.lab_available.place(x=316, y=175)
        self.lab_unavailable.place(x=100, y=175)
        ...
        self.lst_available = tk.Listbox(self.page5, listvariable=var_available, font=f1, width=14, height=10, yscrollcommand=self.scroll_available.set)
        self.lst_available.place(x=285, y=201)

        var_unavailable = tk.StringVar()
        self.lst_unavailable = tk.Listbox(self.page5, listvariable=var_unavailable, font=f1, width=14, height=10, yscrollcommand=self.scroll_unavailable.set)
        self.lst_unavailable.place(x=80, y=201)

        var_allmembers = tk.StringVar()
        self.lst_allmembers = tk.Listbox(self.page5, listvariable=var_allmembers, font=f1, width=14, height=7, yscrollcommand=self.scroll_allmembers.set)
        ...
        self.btn_try.place(x=292, y=575)
        self.btn_reset.place(x=357, y=575)

        self.lst_color = tk.Listbox(self.page5, width=14, height=7, font=f1, selectmode=tk.MULTIPLE, yscrollcommand=self.scroll_color.set)
...
class Page7:
    def __init__(self, master=None):
        ...
        self.lab_title = tk.Label(self.page7, relief='solid', width=15, height=1, text='出缺勤', font=f2, anchor='nw').place(x=0, y=100)
