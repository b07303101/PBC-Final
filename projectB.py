...
class Meetings(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.lblTitle_A = tk.Label(self, text = "會議", height = 1, width = 10, font = f1, bg = 'blue')
        # self.lblTitle_A = tk.Label(self, text = "會議", height = 1, width = 10, font = f1).place(x = 50, y = 100, anchor = 'sw')
