...
class PageA:
    ...
    def create_window(self):
        ...
        if __name__ == '__main__':  
            ...
            self.date = tk.Entry(self.window, textvariable = date_str,width = 30)  # 放選擇的日期
            self.date.place(x = 175, y = 180)
            ...
            def press_add():
                ...
                date_label.place(x = 70, y = 90, relx = 1/20, rely = 1/6, relwidth = 4/8, relheigh = 2/30)
                date.delete(0,"end")
            def write():
                press_add()
            ...
            tk.Button(self.window, text = '選擇日期:', command = date_str_gain).place(x = 60, y = 180)
            tk.Button(self.window, text = "新增日期", command = press_add).place(x = 350, y = 320, relx = 1/20, rely = 1/6, relwidth = 4/80, relheigh = 2/30)
            tk.Button(self.window, text = "確定",command = write).place(x = 450, y = 320, relx = 1/20, rely = 1/6, relwidth = 4/80, relheigh = 2/30)
